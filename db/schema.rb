...
ActiveRecord::Schema[7.0].define(version: 2018_07_23_102908) do
  create_table "contact_groups", charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "contact_memberships", charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "contact_relationships", id: false, charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "email_addresses", charset: "utf8mb3", force: :cascade do |t|
    t.integer "contact_id"
    t.string "title"
    t.text "description"
    t.string "email"
  ...
  create_table "phone_numbers", charset: "utf8mb3", force: :cascade do |t|
    t.integer "contact_id"
    t.string "title"
    t.string "number"
    t.text "description"
  ...
  create_table "post_addresses", charset: "utf8mb3", force: :cascade do |t|
    t.integer "contact_id"
    t.string "title"
    t.text "description"
    t.text "address"
  ...
  create_table "websites", charset: "utf8mb3", force: :cascade do |t|
    t.integer "contact_id"
    t.string "title"
    t.text "description"
    t.string "link"
