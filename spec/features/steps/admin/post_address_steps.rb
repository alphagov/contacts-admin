module Admin
  module PostAddressSteps
    ...
    def post_address_exists(contact_record, post_address)
      ensure_on admin_contact_record_post_addresses_path(contact_record)
    ...
    def delete_post_address(post_address)
      ensure_on admin_contact_record_post_addresses_path(
        post_address.contact_record,
        post_address
      )
    ...
    def update_post_address(post_address, new_details = {})
      ensure_on edit_admin_contact_record_post_address_path(
        post_address.contact_record,
        post_address
      )
    ...
    def create_post_address(contact_record, details = {})
      ensure_on new_admin_contact_record_post_address_path(contact_record)
